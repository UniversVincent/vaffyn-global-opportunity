    ...
    return (
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            'fixed z-[999] grid w-full gap-4 rounded-b-lg bg-surface-dialog pb-6 text-text-primary animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-10 sm:rounded-lg',
            isSmallScreen
